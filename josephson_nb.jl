...
using WGLMakie, LinearAlgebra, PlutoUI, LaTeXStrings, DynamicalSystems,IntervalRootFinding, IntervalArithmetic
...
md"β: $(@bind β Slider(-10:1e-6:10; default=5, show_value=true)) # Parâmetro de McCumber (adimensional)" 
...
Jacobiana analítica:
```math
	\Large J_F\begin{pmatrix}x\\y\end{pmatrix}=
	\begin{pmatrix}
	0 & 1\\
	\frac{-cos(x)}{\beta} & \frac{-1}{\beta}
	\end{pmatrix}
```
...
manifest_format = "2.0"
project_hash = "7f079ba4eebabe5bc0b036870b02e113f0772e6a"
...
[[deps.Attractors]]
deps = ["BlackBoxOptim", "Clustering", "ComplexityMeasures", "Distances", "Distributions", "DynamicalSystemsBase", "LinearAlgebra", "Mmap", "Neighborhood", "OhMyThreads", "Optim", "ProgressMeter", "Random", "Reexport", "StateSpaceSets"]
git-tree-sha1 = "b7342a90839bf8d6e0096606bb1c816a199c7f11"
...
[[deps.BlackBoxOptim]]
deps = ["Compat", "Distributed", "Distributions", "LinearAlgebra", "Printf", "Random", "Requires", "SpatialIndexing", "StatsBase"]
git-tree-sha1 = "870e8b6e05cbf498491392b911c71e97b9fe1423"
...
deps = ["Combinatorics", "DelayEmbeddings", "Distances", "FFTW", "KrylovKit", "LinearAlgebra", "Neighborhood", "QuadGK", "Random", "Reexport", "SparseArrays", "SpecialFunctions", "StateSpaceSets", "StaticArrays", "Statistics", "StatsBase", "StatsFuns", "Wavelets"]
git-tree-sha1 = "3f1d4a27d43985e556a7f4e5cd1655dc9d687dff"
...
deps = ["Attractors", "ChaosTools", "ComplexityMeasures", "DataStructures", "DelayEmbeddings", "DynamicalSystemsBase", "FractalDimensions", "PeriodicOrbits", "PredefinedDynamicalSystems", "RecurrenceAnalysis", "Reexport", "SignalDecomposition", "StateSpaceSets", "Statistics", "TimeseriesSurrogates"]
git-tree-sha1 = "bd16035bcd9778191eaa1535f2132706ea6193a0"
...
git-tree-sha1 = "0c2cef6fbf74ad75c55952b63aeb75cda3f757f3"
...
deps = ["ChunkSplitters", "ComplexityMeasures", "Distances", "Distributions", "HypothesisTests", "Neighborhood", "ProgressMeter", "Random", "Reexport", "Roots", "Scratch", "SpecialFunctions", "StateSpaceSets", "Statistics"]
git-tree-sha1 = "8cf4d9df5c5689588665322942f25b96088798e4"
...
[[deps.LPVSpectral]]
deps = ["DSP", "FFTW", "LinearAlgebra", "Printf", "ProximalOperators", "Random", "RecipesBase", "Requires", "Statistics", "StatsBase"]
git-tree-sha1 = "933ba45f43990e7ebb82b666807e0b091a4050a3"
...
git-tree-sha1 = "ce45dd7e3a54842037b52c290915a01aeecce026"
...
git-tree-sha1 = "c7c8c0e4b87e9d79df0646a5c1e4aa06a07e3ffb"
...
[[deps.PeriodicOrbits]]
deps = ["Combinatorics", "DynamicalSystemsBase", "LinearAlgebra", "NonlinearSolve", "Random", "Reexport"]
git-tree-sha1 = "4170a62ad6534b46dcfc99e0b1305067ec0d3864"
uuid = "41be5fce-5647-450b-ae37-a6739b881a1c"
version = "0.1.1"
...
git-tree-sha1 = "d825b1d367779b1efa355d0bcd8d23096d06fb0f"
...
git-tree-sha1 = "5f87d64ac43cdff3288efaf85fff126f632c1ede"
...
git-tree-sha1 = "8e680fb9e8b3fb7eb66bf4ead84a646ee4e9ef8b"
...
[[deps.SignalDecomposition]]
deps = ["BandedMatrices", "Dates", "DelayEmbeddings", "FFTW", "LPVSpectral", "LinearAlgebra", "Loess", "Neighborhood", "Polynomials", "Random", "SparseArrays", "StaticArrays", "Statistics"]
git-tree-sha1 = "eee3ec79d6d580ebcde541dd5c3e5ab4dd60361b"
...
git-tree-sha1 = "3cb1c581c396d534d86525cf9cb3a1e54f906f83"
...
deps = ["AbstractFFTs", "DSP", "DelayEmbeddings", "Distances", "Distributions", "Interpolations", "LinearAlgebra", "LombScargle", "OhMyThreads", "Random", "StateSpaceSets", "Statistics", "StatsAPI", "StatsBase", "Wavelets"]
git-tree-sha1 = "5587c2f6e7eb7e224d56140238faa434bc5fdd17"
